        ...
        {filteredPosts?.map((post: any) => (
          <div key={post.post_id} className="bg-darkblue mb-4 p-5 rounded-lg transition-transform hover:scale-105">
            <div className="flex flex-row gap-7 items-start">
              <Link to='/profile' onClick={() => _setprofile(post.user_id)}>
            ...
            {/* <div>
      <h1>Image Display</h1>
      <img src="https://connectapi.tharanitharan-n2022cse.workers.dev/.well-known/kv/1713948011627-cement-cyclone-preheater-structure-1.jpg" alt="Image" />
    </div> */}

            {/* <img src="https://connectapi.tharanitharan-n2022cse.workers.dev/.well-known/kv/1713948011627-cement-cyclone-preheater-structure-1.jpg" alt="niu"/> */}
          </div>
        ))}
      </div>
    </div>
